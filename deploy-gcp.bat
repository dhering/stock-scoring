...
call gcloud functions deploy stock-dumper --region europe-west3 --memory=256MB --runtime=python38 --source=gs://stock-storage-sourcecode/dist/gcp-dumper-function.zip --max-instances=2 --trigger-topic=stock-dump --entry-point=dump_stock